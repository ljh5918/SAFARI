...
// const Product = () => {
//   const [products, setProducts] = useState([]); // Maintain product list
//   const [filteredProducts, setFilteredProducts] = useState([]); // Maintain filtered product list
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
//   const [currentPage, setCurrentPage] = useState(0); // Track current page
...
//       const items = response.data.items || [];
//       setProducts(items);
//       setFilteredProducts(items); // Set filtered products to the fetched items
...
//       product.itemNm.toLowerCase().includes(query)
//     );
