...
//     navigate(`/products/${productId}`); // Change the path as needed
//   };
...
//               onClick={() => handleClick(product.id)} // Call handleClick
//             >
        ...
        <div className={styles.productGrid}>
          {products.map((product) => (
            <div
              key={product.id}
              className={styles.productBox}
              onClick={() => handleClick(product.id, soldItems.includes(product.id))} // Pass sold status
            >
              <div className={styles.productImg}>
                <img
                  src={`http://localhost:8080${product.imgUrl}`}
