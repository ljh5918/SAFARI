...
//   const validationSchema = Yup.object({
//     itemNm: Yup.string().required('Please enter a product name.'),
//     itemCategory: Yup.string().required('Please select a category.'),
//     price: Yup.number().required('Please enter a price.'),
//     itemDetail: Yup.string().required('Please enter a detailed description.'),
//     stockNumber: Yup.number().required('Please enter a stock quantity.'),
//     itemSellStatus: Yup.string().required('Please select a status.'),
//   });
...
//             <label htmlFor="price">* 가격</label>
//             <br />
//             <Field type="number" id="price" name="price" className={styles.inputHalf} placeholder="가격을 입력해주세요." />
//             <ErrorMessage name="price" component="div" className={styles.error} />
//           </div>
//           <hr className={styles.hr2} />
//           <div>
//             <label htmlFor="itemDetail">* 상품 설명</label>
//             <br />
//             <Field as="textarea" id="itemDetail" name="itemDetail" className={styles.inputTextArea} placeholder="상품에 대한 설명을 입력해주세요." />
//             <ErrorMessage name="itemDetail" component="div" className={styles.error} />
//           </div>
//           <hr className={styles.hr2} />
//           <div>
...
//             <label>* 판매 상태</label>
//             <br />
//             <Field as="select" name="itemSellStatus" className={styles.select}>
